...
petForm.addEventListener('submit', APIController)

function formSubmittal(e) {
    e.preventDefault();
...
function APIController(e) {
    ...
    async function _getToken() {
        ...
        const result2 = await fetch(`https://api.petfinder.com/v2/animals?type=dog&page=1&location=${zip}`, {
            method: 'GET',
            headers: {
