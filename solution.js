...
// scroll to form on back btn click
function scrollForm() {
const backBtn = document.querySelector('.go-back');
    ...
    backBtn.addEventListener('click', () => {
                ...
                window.location.href = 'index.html#targetElement';
    ...
    div.innerHTML = `
        <div class="details-card">
            ...
            <div class="details-description">
                ...
                <div class="details-description-flex highlight">
                    <p>${dog.animal.age}</p>
                ...
                <h4>Description</h4>
                <p class="details-description-text">${dog.animal.description}</p>
                <h4>Characteristics:</h4>
                <p id="tags-container" class="tags-container"></p>
                <div class="details-description-grid">
                <a href="${dog.animal.url}" target="_blank" class="btn">More Details</a>
        ...
        animalTagSplit(dog.animal.tags);
}


function animalTagSplit(data) {
    const grid = document.getElementById('tags-container');
    console.log(data)
    if(data.length === 0) {
        const cell = document.createElement('div'); 
        cell.textContent = "meet me to find out!";
